...
//    Path filepath;
    ...
    public void serveResource(GridFsResource resource, GridFSDownloadStream gridFSDownloadStream) throws Exception {

        Long length = resource.contentLength();
        String fileName = resource.getFilename();
        FileTime lastModifiedObj = FileTime.fromMillis(resource.lastModified());
        ...
        // Prepare streams.
        try (InputStream input = new BufferedInputStream(gridFSDownloadStream);
